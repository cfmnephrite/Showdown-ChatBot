 ...
 = [
	...
	getZMove(move, pokemon, skipChecks) {
		...
		if (item.zMoveSpecialMoves && !!item.zMoveSpecialMoves[pokemon.baseSpecies.baseSpecies]) {
			...
			if (_optionalChain([zMove, 'access', _ => _.zMoveSpecialMoveFrom, 'optionalAccess', _2 => _2.includes, 'call', _3 => _3(move.name)]) ||
	...
	canMegaEvo(pokemon) {
		...
		const item = pokemon.getItem();
		// Mega Rayquaza
		if (_optionalChain([altForme, 'optionalAccess', _6 => _6.isMega]) && _optionalChain([altForme, 'optionalAccess', _7 => _7.requiredMove]) &&
	...
	getActiveMaxMove(move, pokemon) {
		...
		if (move.category !== 'Status') {
			...
			if (!_optionalChain([move, 'access', _8 => _8.maxMove, 'optionalAccess', _9 => _9.basePower])) throw new Error(`${move.name} doesn't have a maxMove basePower`);
	...
	runZPower(move, pokemon) {
		...
		} else if (_optionalChain([move, 'access', _10 => _10.zMove, 'optionalAccess', _11 => _11.boost])) {
			this.boost(move.zMove.boost, pokemon, pokemon, zPower);
		} else if (_optionalChain([move, 'access', _12 => _12.zMove, 'optionalAccess', _13 => _13.effect])) {
